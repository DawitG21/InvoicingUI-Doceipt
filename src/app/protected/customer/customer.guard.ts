...
export class CustomerGuard implements CanDeactivate<EditCustomerComponent> {

  constructor(
    public dialog: MatDialog,
  ) { }

  public async canDeactivate(component: EditCustomerComponent) {
    if ((component.form.touched && component.form.dirty) || component.customerGroupChanged) {
