...
export class FinancialPeriodGuard implements CanDeactivate<EditFinancialPeriodComponent> {

  constructor(
    public dialog: MatDialog,
  ) { }

  public async canDeactivate(component: EditFinancialPeriodComponent) {
